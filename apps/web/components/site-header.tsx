  ...
  return (
    <header className="sticky top-0 z-50">
      <div className={cn(siteRailInsetClass, "pt-4 pb-3")}>
        <div
          className={cn(
            "mx-auto flex w-full items-center justify-between gap-3 rounded-2xl border px-3 py-2 transition-[max-width,background-color,border-color,box-shadow,backdrop-filter] duration-200 ease-out sm:gap-4 sm:px-4 sm:py-2.5",
